...
- Portable financial CSV (Header download/import) latest template:
  templates/finance-import/financial-data-2026-08-06 (9)_updated.csv
  Includes history columns, warehouse_lot_id / budget_amount on expenses,
  type=warehouse_lot unit-cost rows, warehouse_item_id, qty.
